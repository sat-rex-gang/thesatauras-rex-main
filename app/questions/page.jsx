              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="p-6 bg-green-50 hover:bg-green-100 rounded-lg border-2 border-green-200 hover:border-green-300 transition-all text-left opacity-50 cursor-not-allowed"
                    disabled
                  >
                    <div className="text-green-600 text-2xl mb-2">🔢</div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Math</h3>
                    <p className="text-sm text-gray-600">
                      Math practice questions coming soon! Algebra, geometry, and advanced math topics.
                    </p>
                  </motion.button>
                </div>
              </GlassComponents>
